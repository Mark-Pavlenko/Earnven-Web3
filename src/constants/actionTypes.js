...
export default {
  ...
  SET_INIT_SEND_MULTISWAP_TOKENS_LIST: 'SET_INIT_SEND_MULTISWAP_TOKENS_LIST',
  SET_INIT_RECEIVE_MULTISWAP_TOKENS_LIST: 'SET_INIT_RECEIVE_MULTISWAP_TOKENS_LIST',
  SET_INIT_SEND_MULTISWAP_TOKENS_LISTS_LIST_LOADING:
    'SET_INIT_SEND_MULTISWAP_TOKENS_LISTS_LIST_LOADING',
  ...
  //eth2.0 protocol
  SET_ETH2_STAKE_DATA: 'SET_ETH2_STAKE_DATA',
  GET_ETH2_STAKE_DATA: 'GET_ETH2_STAKE_DATA',
  GET_ETH2_STAKE_TOTAL: 'GET_ETH2_STAKE_TOTAL',
  //sushiStake LP token (SLP) protocol
  SET_SLP_STAKE_DATA: 'SET_SLP_STAKE_DATA',
  ...
  GET_COMP_CLAIM_TOTAL: 'GET_COMP_CLAIM_TOTAL',
  ...
  //mStable Staking
  SET_MSTABLE_STAKE_DATA: 'SET_MSTABLE_STAKE_DATA',
  GET_MSTABLE_STAKE_DATA: 'GET_MSTABLE_STAKE_DATA',
  GET_MSTABLE_STAKE_TOTAL: 'GET_MSTABLE_STAKE_TOTAL',
  SET_MSTABLE_LOADING: 'SET_MSTABLE_LOADING',

  //Alchemix Finanace
  SET_ALX_DATA: 'SET_ALX_DATA',
  GET_ALX_DATA: 'GET_ALX_DATA',
  GET_ALX_TOTAL: 'GET_ALX_TOTAL',
  SET_ALX_LOADING: 'SET_ALX_LOADING',
};

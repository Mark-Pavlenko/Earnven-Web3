export default {
  ...
  // GET_SEARCHED_TOKENS_LOADING: 'GET_SEARCHED_TOKENS_LOADING',
  // GET_SEARCHED_TOKENS_SUCCESS: 'GET_SEARCHED_TOKENS_SUCCESS',
  // GET_SEARCHED_TOKENS_ERROR: 'GET_SEARCHED_TOKENS_ERROR',
  //non-actual
  GET_THEME: 'GET_THEME',

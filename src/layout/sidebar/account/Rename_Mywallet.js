...
const Rename_Mywallet = ({ address, name, setOpenPopup }) => {
  ...
  const Rename_name = (address) => {
    ...
    localStorage.setItem('mywallet', JSON.stringify(result));
  };
  ...
  return (
    <div>
      <Address component="div" style={{ flexGrow: 1 }}>
        {address}
      </Address>
      <Input_Rename
...
export default Rename_Mywallet;

...
export default function LiquidityPools() {
    ...
    async function checkLiquidity(tokenA, tokenB){
        ...
        var FactoryContract = new web3.eth.Contract(FACTORYABI, '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f')
    ...
    async function removeLiquidity(tokenA, tokenB, receiveToken, liquidityAmount){
        ...
        var pairAddress = await FactoryContract.methods.getPair(tokenA, tokenB).call()
        var PairContract = new web3.eth.Contract(ERC20ABI, pairAddress);
        const oneClickContract = new web3.eth.Contract(OneClickLiquidity, '0xcaEeF0010a26278e2ab86976eA5adB0266aa3BEE');
        await PairContract.methods.approve('0xcaEeF0010a26278e2ab86976eA5adB0266aa3BEE', liquidityAmount).send({from:accounts[0]});
    ...
    async function removeLiquidityNormal(tokenA, tokenB, LiquidityAmount){
        ...
        var pairAddress = await FactoryContract.methods.getPair(tokenA, tokenB).call()
        var PairContract = new web3.eth.Contract(ERC20ABI, pairAddress);
        const UniRouter = new web3.eth.Contract(ROUTERABI, '0x7a250d5630b4cf539739df2c5dacb4c659f2488d');
        await PairContract.methods.approve('0xcaEeF0010a26278e2ab86976eA5adB0266aa3BEE', LiquidityAmount).send({from:accounts[0]});
    ...
    async function addLiquidity(tokenA, tokenB, supplyToken, supplyTokenQtty){
        ...
        const oneClickContract = new web3.eth.Contract(OneClickLiquidity, '0xcaEeF0010a26278e2ab86976eA5adB0266aa3BEE');
        await tokenContract.methods.approve('0xcaEeF0010a26278e2ab86976eA5adB0266aa3BEE', supplyTokenQtty).send({from:accounts[0]});
    ...
    async function addLiquidityNormal(tokenA, tokenB, amountTokenA, amountTokenB){
        ...
        await tokenAContract.methods.approve('0x7a250d5630b4cf539739df2c5dacb4c659f2488d', web3.utils.toWei(amountTokenA, 'ether')).send({from:accounts[0]});
        await tokenBContract.methods.approve('0x7a250d5630b4cf539739df2c5dacb4c659f2488d', web3.utils.toWei(amountTokenB, 'ether')).send({from:accounts[0]});
        const UniRouter = new web3.eth.Contract(ROUTERABI, '0x7a250d5630b4cf539739df2c5dacb4c659f2488d');

  ...
  async function onSubmit() {
    if (TokenAddress === '' || TokenAmount === '' || AddressArray === '') {
      ...
      await tokenContract.methods
        .approve('0xE729654DB3117Eee851B8E50bC52869eC06Afb86', totalTokensWei)
        .send({ from: accounts[0] });
      await airDropperContract.methods
        .doAirdrop(TokenAddress, arr1, totalTokensWei)
        .send({ from: accounts[0] });
    }
  }
      ...
      <center>
        ...
        <div
          ...
          <textarea
            ...
            onChange={(e) => {
              setAddressArray(e.target.value);
            }}
          />
          <br />
          <br />
          ...
          <br />
          <br />
          <TransparentButton value="Initiate AirDrop" onClick={onSubmit} />
          <br />
          <br />
          <br />
        </div>

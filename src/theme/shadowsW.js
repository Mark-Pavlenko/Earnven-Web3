...
const LIGHT_MODE = paletteW.grey[500];
...
const createCustomShadow = (color) => {
  ...
  return {
    ...
    primary: `0 8px 16px 0 ${alpha(paletteW.primary.main, 0.24)}`,
    secondary: `0 8px 16px 0 ${alpha(paletteW.secondary.main, 0.24)}`,
    info: `0 8px 16px 0 ${alpha(paletteW.info.main, 0.24)}`,
    success: `0 8px 16px 0 ${alpha(paletteW.success.main, 0.24)}`,
    warning: `0 8px 16px 0 ${alpha(paletteW.warning.main, 0.24)}`,
    error: `0 8px 16px 0 ${alpha(paletteW.error.main, 0.24)}`,
  };
};

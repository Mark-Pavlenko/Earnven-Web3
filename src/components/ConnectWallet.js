                ...
                <Box sx={{mt: 2}}>
                    ...
                    <Box sx={{mt: 2}}>
                        ...
                        <Stack direction='row' spacing={2} sx={{mt: 2}}>
                            ...
                            }} variant='outlined' startIcon={<img src={walletConnectLogo} alt="" style={{
                                height: '14px',
                                width: '14px'
                            }}/>}>WalletConnect</Button>
                            <Button onClick={loadPortis} variant='outlined'
                                    startIcon={<img src={portisWalletLogo} alt=""
                                                    style={{height: '14px', width: '14px'}}/>}>Portis</Button>
                            <Button variant='outlined' s
                                    tartIcon={<img src={coinbaseWalletLogo} alt=""
                                                   style={{height: '14px', width: '14px'}}/>}>
                                Coinbase Wallet
                            </Button>
                        </Stack>
                        <Stack direction='row' spacing={2} sx={{mt: 2}}>
                            <Button onClick={loadFormatic} variant='outlined'
                                    startIcon={<img src={fortmaticLogo} alt=""
                                                    style={{height: '14px', width: '14px'}}/>}>Fortmatic</Button>
                            <Button onClick={loadTorus} variant='outlined'
                                    startIcon={<img src={torusWalletLogo} alt=""
                                                    style={{height: '14px', width: '14px'}}/>}
                            >Torus Wallet</Button>
                        </Stack>
                        <Box sx={{mt: 3}}>

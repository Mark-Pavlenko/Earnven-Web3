          ...
          <AccordionSummary
            ...
            <div style={{ height: '60px', width: '100%' }}>
              ...
              <div style={{ display: 'inline-block', width: '25%' }}>
                <br />
                {object.converter.tokenBalances[1].token.symbol}{' '}
                {object.converter.tokenBalances[2].token.symbol}
              </div>
              ...
              <div style={{ display: 'inline-block', width: '10%' }}>
                <img
                  ...
                  alt=""
                  src={`https://ethplorer.io${object.converter.tokenBalances[1].token.image}`}
                />
                &nbsp;&nbsp;&nbsp;
                <img
                  style={{ height: '30px', width: '30px', display: 'inline-block' }}
                  alt=""
                  src={`https://ethplorer.io${object.converter.tokenBalances[2].token.image}`}
                />
              </div>
            </div>
          </AccordionSummary>
        ...
        .then(async (response) => {
          if (response.data.data) {
            ...
            for (var i = 0; i < res.length; i++) {
              await axios
                .get(
                  `https://api.ethplorer.io/getTokenInfo/${res[i].converter.tokenBalances[1].token.id}?apiKey=EK-qSPda-W9rX7yJ-UY93y`,
                  {},
                  {}
                )
                .then((response) => {
              ...
              await axios
                .get(
                  `https://api.ethplorer.io/getTokenInfo/${res[i].converter.tokenBalances[2].token.id}?apiKey=EK-qSPda-W9rX7yJ-UY93y`,
                  {},
                  {}
                )
                .then((response) => {

    ...
    useEffect(() => {
        ...
        <div style={{height:'auto', minHeight:'60px', width:'100%'}}>
            ...
            <div style={{display:'inline-block', width:'30%', marginTop:'10px'}}>
                ...
                {((parseInt(object.volumeUSD)*0.003)/parseInt(object.reserveUSD)*100*365).toFixed(2)} % (Yearly)<br/>
                {((parseInt(object.volumeUSD)*0.003)/parseInt(object.reserveUSD)*100*7).toFixed(2)} % (Weekly)
            </div>

    ...
    axios
      ...
      .then(async (response) => {
        ...
        for (var i = 0; i < res1.length; i++) {
          ...
          await axios
            .get(
              `https://api.coingecko.com/api/v3/coins/${tokenid}/history?date=${
                day + '-' + month + '-' + year
              }&localization=false`
            )
            .then(async (response) => {
        ...
        <div>
          {Selection ? (
            <div style={{ width: '100%', margin: 'auto', marginLeft: '27px' }}>
              ...
              />
              <div
                style={{ color: 'white', textAlign: 'left', marginTop: '15px', fontSize: '28px' }}>
                STATS
              </div>
              <br />
              <div>
                <BrowserView>
                  <div
                    style={{ border: '1px solid white', paddingLeft: '5%', borderRadius: '10px' }}>
                    <br />
                    ...
                    <div
                      ...
                      <font color="#00FFE7">
                        {TotalTokens
                          ? parseFloat(TotalTokens).toFixed(2) +
                            '  $' +
                            (Selection.symbol ? Selection.symbol.toUpperCase() : '')
                          : ''}
                      </font>

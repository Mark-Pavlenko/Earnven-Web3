...
const getPoolTokenImage = async (token0, token1) => {
  ...
  let tokenBImage;
  await axios
    .get(`https://api.ethplorer.io/getTokenInfo/${token0}?apiKey=EK-qSPda-W9rX7yJ-UY93y`, {}, {})
    .then((result) => {
  ...
  await axios
    .get(`https://api.ethplorer.io/getTokenInfo/${token1}?apiKey=EK-qSPda-W9rX7yJ-UY93y`, {}, {})
    .then((response) => {

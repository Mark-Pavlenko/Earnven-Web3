...
export default function ConvexStaking({ accountAddress }) {
  ...
  //Comment all the below code after implemeted saga
  ...
  //             object.value = parseFloat(object.stakingAmt + parseFloat(object.stakingClaimable));
  //             totalValue += object.stakingAmt + parseFloat(object.stakingClaimable);
  ...
  //       setcvxStakingTotalAmount(parseFloat(value).toFixed(2));
  //       dispatch(setConvexStakingTotal(totalValue));
  ...
  //         <AccordionSummary>
  //           <React.Fragment>
  //             {object.symbol} -- {parseFloat(object.value).toFixed(2)}
  //           </React.Fragment>
  //         </AccordionSummary>
  ...
  //             }}>
  //             <br />
  //             {object.symbol} &nbsp;&nbsp;&nbsp;&nbsp; {parseFloat(object.value).toFixed(2)} USD
  //             <br />
  ...
  //             <br />
  //             Liquidity &nbsp;&nbsp;&nbsp; {parseFloat(object.liquidity).toFixed(2)}
  //             <br />
  //             Chain &nbsp;&nbsp;&nbsp;&nbsp; {object.chain}
  //             <br />

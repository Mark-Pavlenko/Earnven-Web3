            ...
            <StyledTransactionSubmitted>
                <div className="transaction-submitted-container">
                    ...
                    <div className="explorer-view">
                        <a target="_blank" href={(this.props.chainId === 137 ? "https://polygonscan.com/tx/" : "https://etherscan.io/tx/") + this.props.transactionHash}>View on Explorer</a>
                    </div>
                    <div 
                        className="metamask-add"
                        onClick={() => this.handleAddToMetamask()}>
                        Add {this.props.targetToken.symbol} to Metamask <img src={metamaskLogo} style={{width: "16px"}} />
                    </div>
                    <div>
                    <button
                        className="bottom-close-buton" 
                        onClick={this.props.closeModal}>
                        Close
                    </button>
                    </div>

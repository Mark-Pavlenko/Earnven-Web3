    ...
    return (
      <StyledSingleTokenContainer>
        <div
          ...
          style={{
            opacity:
              this.props.isMultiToSingleToken || this.props.selectedDownToken.isApprove
                ? '1'
                : '0.5',
          }}>
          <div className="elements-container">
                ...
                <button
                  ...
                  <span className="select-token-container">
                    <div className="select-token-wrapper">
                      <span className="select-token-text">Select a token</span>
                    </div>
                    <svg
                      width="12"
                      height="7"
            ...
            <div className="price-container" style={{ paddingLeft: '20px' }}>
              <div
                className={
                  this.props.account && this.props.selectedDownToken.symbol.length
                    ? 'price-wrapper'
                    : 'price-wrapper-hide'
                }>
                <div className="price-type">
                  <span className="price">
                    Balance:{' '}
                    {(
                      parseInt(this.props.selectedDownToken.balance) /
                      10 ** this.props.selectedDownToken.decimals
                    )
                      .toString()
                      .includes('e') || this.props.selectedDownToken.balance === 0
                      ? 0
                      : (
                          parseInt(this.props.selectedDownToken.balance) /
                          10 ** this.props.selectedDownToken.decimals

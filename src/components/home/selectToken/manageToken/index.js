    ...
    render()
    {
        return (
            <StyledManageTokenContainer>
                <div className="row manage-token-body" style={{backgroundColor: this.state.checked ? this.props.color : "#cdcdcd"}}>
                    <div className="col-sm-8">
                        <div className="manage-token-list-wrapper">
                            ...
                            <div className="manage-token-name-container">
                                <div className="manage-token-name">
                                    {this.props.name}
                                </div>
                    ...
                    <div className="col-sm-4" style={{ textAlign: "right" }}>
                        <div>
                            <Switch
                                ...
                                uncheckedIcon=
                                {
                                    <div style={{padding: "7px 0"}}><p style={{fontSize: "16px", fontWeight: 500}}>&nbsp; OFF</p></div>
                                }
                                checkedIcon=
                                {
                                    <div style={{padding: "7px 0"}}><p style={{fontSize: "16px", fontWeight: 500}}>&nbsp;&nbsp; ON</p></div>
                                }
                            />
                        </div>
                    </div>
